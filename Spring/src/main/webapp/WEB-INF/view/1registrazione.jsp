...
<body>
	<div class="row">
        ...
        <div class="col-sm-6 col-lg-12" id="cont1">
                ...
                <img id="imgSignUp" src="images/pizza_signup.jpg" alt="">
            
        </div>

        <div class="col-sm-6 col-lg-12" id="cont2">
            <div id="formSignUp">
                <form:form class="row g-3" action="home.html" method="POST" modelAttribute="utente" acceptCharset="ISO-8859-1">
                    ...
                    <div class="col-md-6">
                        ...
                        <form:input path="telefono" id="mail" class="form-control" id="telefSigIn" required="required" placeholder=""/>
                    </div>
